...
p20.addEventListener("click", () => {
  const options = {
    ...
    imageUrl: '../images/6-martin-cuaya/Pintura 20-min.jpg',
    imageHeight: 'auto',
    width:"90%",
    height:"80vh",
    backdrop: true,
...
p21.addEventListener("click", () => {
  const options = {
    showCloseButton: true,
    showConfirmButton:  false,
    imageUrl: '../images/6-martin-cuaya/Pintura 21-min.jpg',
    imageHeight: 'auto',
    width:"90%",
    height:"80vh",
    backdrop: true,
...
p22.addEventListener("click", () => {
  const options = {
    showCloseButton: true,
    showConfirmButton:  false,
    imageUrl: '../images/6-martin-cuaya/Pintura 22-min.jpg',
    imageHeight: 'auto',
    width:"90%",
    height:"80vh",
    backdrop: true,
...
p23.addEventListener("click", () => {
  const options = {
    showCloseButton: true,
    showConfirmButton:  false,
    imageUrl: '../images/6-martin-cuaya/Pintura 23-min.jpg',
    imageHeight: 'auto',
    width:"90%",
    height:"80vh",
    backdrop: true,
...
p24.addEventListener("click", () => {
  const options = {
    showCloseButton: true,
    showConfirmButton:  false,
    imageUrl: '../images/6-martin-cuaya/Pintura 24-min.jpg',
    imageHeight: 'auto',
    width:"90%",
    height:"80vh",
    backdrop: true,
